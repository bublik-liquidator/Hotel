...
const appRoutes: Routes = [
  ...
  {path:'admin',component:AdminComponent, canActivate: [AuthGuardGuard], data: {expectedRoles: ['admin']}},
  {path:'manager',component:ManagerComponent, canActivate: [AuthGuardGuard], data: {expectedRoles: ['admin', 'manager']}},
